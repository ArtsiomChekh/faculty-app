    ...
    public void initialize() {
        if (departmentRepository.count() < 3) {
            ...
            department1.setDescription("Направления научных исследований:\n"
                    + "1) Совершенствование геодезических методов мониторинга геодинамических процессов с привлечением " +
                    "глобальных моделей Земли и обеспечением многодисциплинарного подхода\n"
                    + "2) Математическая обработка результатов геодезических измерений\n"
                    + "3) Моделирование развития деформационных процессов природных и инженерных объектов по " +
                    "геопространственным данным с представлением в среде ГИС\n"
